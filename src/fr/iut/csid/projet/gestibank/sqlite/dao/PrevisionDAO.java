...
////		private static final int NUM_COL_ID_ACCOUNT = 4;
//	private static final String COL_ID_BUDGET = "ID_BUDGET";
//	private static final int NUM_COL_ID_BUDGET = 4;
//	
//	private SQLiteDatabase bdd;
//	private TransactionBaseSQLite transactionBaseSQLite;
//	
//	
//	//CONSTRUCTEURS
//	public TransactionBdd(Context context) {
//		transactionBaseSQLite = new TransactionBaseSQLite(context, NOM_BDD, null, VERSION);
//	}
//	
//	
//	//ACCESSEURS
...
//	}
//	
//	public long insertTransaction(int id_budget, Transaction transaction) {
...
//		content.put(COL_ID_BUDGET, id_budget);
//		
...
//			
//			String laDate = c.getString((NUM_COL_DATE));
//			Date.valueOf(laDate);
//			transaction.setDate(Date.valueOf(laDate));
//			
